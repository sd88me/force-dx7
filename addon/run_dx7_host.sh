#!/bin/sh
############################################################
# ForceDX7 — deliberately a no-op.
#
# This addon does not arm any LD_PRELOAD tap or auto-start dx7_host at boot
# - that's ForceAudioJack's job (see its own README.md), and dx7_host is only
...
# PROCESSNAME (run_dx7_host.sh) - if that toggle is ever set despite
